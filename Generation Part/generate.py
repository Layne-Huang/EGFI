...
if __name__ == '__main__':
    ...
    parser.add_argument('--label', type=str, default='mechanism', action='store',
                        help='Label for which to produce text')
    ...
    model_names = ['advise_model.pt365.pt', 'effect_model.pt587.pt', 'mechanism_model.pt.pt', 'int_model.pt.pt']
    ...
    for i, x in enumerate(all):
        ...
        generate(TOKENIZER, MODEL, sentence, label, DEVICE)
