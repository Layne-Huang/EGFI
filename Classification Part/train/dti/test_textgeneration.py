...
def test(config, model_name="ddi_e-5-0.9229.pkl"):
    ...
    if model_name is None:
        ...
        model_path = r"../../checkpoint/dti/BioBert/ddi_e-5/ddi_e-5-2-0.7199.pkl"
    ...
    for i in range(0,5):
        ...
        # print(test_preds_new)
        # exit()
        test_auprc = metrics.average_precision_score(test_labels_new, test_preds_new)

        test_acprc_sum += test_auprc

    auprc = test_acprc_sum/5


    # test_auprc = metrics.average_precision_score(test_labels, test_preds)
